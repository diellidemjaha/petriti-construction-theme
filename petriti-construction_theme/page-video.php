...
<div class="container mt-5">
    <div class="row">
        ...
        $args = array(
            'post_type' => 'video', // Replace with your custom post type name
        ...
        ?>
                 <div class="col-md-6 col-lg-4  col-12 mb-4 d-flex justify-content-center">
                    <a href="<?php the_permalink(); ?>" class="card-link"> <!-- Added anchor tag with permalink -->
